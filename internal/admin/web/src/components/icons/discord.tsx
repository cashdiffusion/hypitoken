...
// Discord brand glyph. Lucide ships no brand icons, so we keep the official
// wordmark-less mascot path here. Inherits `currentColor` like a lucide icon,
// so callers tint it via `text-*` utilities.
