...
export default {
  ...
  invite: {
    ...
    nextTier: "Invite {{count}} more to unlock {{tier}} (reward {{bonus}})",
    tabs: { invite: "Invite", gift: "Gift", received: "Received" },
    linkLabel: "Your personal invite link",
    taglineLabel: "Card tagline (custom)",
    messageLabel: "Note (custom)",
    saveCard: "Save card",
    saving: "Saving…",
    saved: "Card saved",
    share: "Share",
  ...
  gift: {
    ...
    giftableHint: "{{amount}} giftable — topped-up credit only; bonus credit does not count.",
    locked:
      "Sending gift cards requires topped-up credit. Bonus credit (signup gift, referral rewards, goodwill) is yours to spend, but cannot be transferred to another account.",
  ...
  dashboard: {
    ...
    inviteCta: "Invite friends — you both get free credit. You can also gift them your balance.",
